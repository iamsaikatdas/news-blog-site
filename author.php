        ...
        <div class="row">
            <div class="col-md-8">
                <div class="post-container">
                    ...
                    ?>
                    <h2 class="page-heading"><?php echo $data["username"] ?></h2>;
                    <?php
                    include "config.php";
                   ...
                   ORDER BY post_id DESC LIMIT {$offset}, {$limit}";
                                            ...
                                            <div class="inner-content clearfix">
                                                ...
                                                <div class="post-information">
                                                    <span>
                                                        ...
                                                        <a href='category.php?aid=<?php echo $a['category_id'] ?>'><?php echo $a['category_name'] ?></a>
                                                    </span>
                                                    <span>
                    ...
                    if (mysqli_num_rows($result2) > 0) {
                        ...
                        if ($page > 1) {
                            # code...
                            echo '<li><a href="author.php?aid=' . $user_id . '&page=' . $page - 1 . '">Prev</a></li>';
                        }
                        ...
                        for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            if ($total_page == 1) {
                                ...
                                echo '<li class=' . $active . ' ><a href="author.php?aid=' . $user_id . '&page=' . $i . '">' . $i . '</a></li>';
                            }
                        }
                        if ($page < $total_page) {
                            # code...
                            echo '<li><a href="author.php?aid=' . $user_id . '&page=' . $page + 1 . '">Next</a></li>';
                        }
                        echo "</ul>";
                    }
                    ?>
